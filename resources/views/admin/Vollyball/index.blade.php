        ...
        <section class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">VolleyBall Live Score Portal</h3>
                ...
                <div class="row">
                    ...
                    <form id="c_round_f" action="{{ route('volleyball.updateRound', $event->event_id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="current_round" name="current_round" value="{{ $scores[0]['current_round'] }}">
                            </div>
                            </div>
                    ...
                    <div class="col">
                        <button form="c_round_f" type="submit" class="btn btn-primary">Update Round</button>
                    </div>
